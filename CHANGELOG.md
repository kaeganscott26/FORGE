...
- Added a 32 MB direct-read guard before whole-file allocation and normalized `EACCES`/`EPERM` IPC failures into actionable workspace guidance, while preserving permission-tolerant traversal of protected home subtrees.
