...
Current package version is `2.5.0-beta`. The `v2.3.0-beta.1` / **FORGE v2.3 Beta** publication is a prior release record, not the current product identity; historical beta 2.2 evidence remains older still.
