...
| --- | --- | --- | --- |
| Development | `2.1.0-beta.2-dev` | none | Source and renderer development |
| Beta | `2.1.0-beta.2` | `beta`, `rc`, or normal SemVer | Public evaluation before stable |
...
- `FORGE-2.1.0-beta.2-universal.dmg`;
- `FORGE-2.1.0-beta.2-universal.dmg.blockmap`;
- `FORGE-2.1.0-beta.2-universal.zip`;
- `FORGE-2.1.0-beta.2-universal.zip.blockmap`;
- `beta-mac.yml`.
