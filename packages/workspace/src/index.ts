...
export class WorkspaceService extends EventEmitter {
  ...
  info(): WorkspaceInfo | null { return this.rootPath ? { rootPath: this.rootPath, name: path.basename(this.rootPath), gitRoot: null, createdAt: 0 } : null; }
  async close(): Promise<void> { this.watcher?.close(); this.watcher = undefined; this.rootPath = null; this.realRoot = null; }
